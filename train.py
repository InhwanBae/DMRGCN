...
parser.add_argument('--n_tpcnn', type=int, default=5, help='Number of CNN layers')
...
parser.add_argument('--lr_sh_rate', type=int, default=16, help='Number of steps to drop the lr')
